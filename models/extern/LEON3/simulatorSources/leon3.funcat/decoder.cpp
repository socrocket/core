...
leon3_funcat_trap::CacheElem::CacheElem( Instruction * instr, unsigned int count \
    ) : instr(instr), count(count){

}

leon3_funcat_trap::CacheElem::CacheElem() : instr(NULL), count(1){

}

int leon3_funcat_trap::Decoder::decode( unsigned int instrCode ) const throw(){
