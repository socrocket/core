...
bool leon3_funcat_trap::Instruction::IncrementRegWindow() throw(){
    {
        unsigned int newCwp;
...
bool leon3_funcat_trap::Instruction::DecrementRegWindow() throw(){
    {
        unsigned int newCwp;
...
void leon3_funcat_trap::Instruction::RaiseException( unsigned int pcounter, unsigned \
...
bool leon3_funcat_trap::Instruction::checkIncrementWin() const throw(){
...
bool leon3_funcat_trap::Instruction::checkDecrementWin() const throw(){
...
leon3_funcat_trap::Instruction::Instruction( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
...
leon3_funcat_trap::WB_plain_op::WB_plain_op( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
...
leon3_funcat_trap::ICC_writeLogic_op::ICC_writeLogic_op( Reg32_0 & PSR, Reg32_1 & \
...
leon3_funcat_trap::ICC_writeTSub_op::ICC_writeTSub_op( Reg32_0 & PSR, Reg32_1 & WIM, \
...
leon3_funcat_trap::ICC_writeDiv_op::ICC_writeDiv_op( Reg32_0 & PSR, Reg32_1 & WIM, \
    Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, \
    Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, \
    Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) \
    : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, \
...
leon3_funcat_trap::ICC_writeAdd_op::ICC_writeAdd_op( Reg32_0 & PSR, Reg32_1 & WIM, \
    Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, \
    Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, \
    Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) \
    : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, \
...
leon3_funcat_trap::ICC_writeSub_op::ICC_writeSub_op( Reg32_0 & PSR, Reg32_1 & WIM, \
    Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, \
    Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, \
    Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) \
    : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, \
...
leon3_funcat_trap::ICC_writeTAdd_op::ICC_writeTAdd_op( Reg32_0 & PSR, Reg32_1 & WIM, \
    Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, \
    Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, \
    Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) \
    : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, \
...
leon3_funcat_trap::ICC_writeTVSub_op::ICC_writeTVSub_op( Reg32_0 & PSR, Reg32_1 & \
    WIM, Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & \
    GLOBAL, Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias \
    & PCR, Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck \
    ) : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, \
...
leon3_funcat_trap::WB_tv_op::~WB_tv_op(){

}
leon3_funcat_trap::WB_tv_op::WB_tv_op( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
...
leon3_funcat_trap::ICC_writeTVAdd_op::ICC_writeTVAdd_op( Reg32_0 & PSR, Reg32_1 & \
    WIM, Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & \
    GLOBAL, Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias \
    & PCR, Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck \
    ) : Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, \
...
std::string leon3_funcat_trap::InvalidInstr::getInstructionName() const throw(){
    return "InvalidInstruction";
}

std::string leon3_funcat_trap::InvalidInstr::getMnemonic() const throw(){
    return "invalid";
}

unsigned int leon3_funcat_trap::InvalidInstr::getId() const throw(){
    return 144;
}

leon3_funcat_trap::InvalidInstr::InvalidInstr( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::READasr::getInstructionName() const throw(){
    return "READasr";
}

unsigned int leon3_funcat_trap::READasr::getId() const throw(){
    return 126;
}
...
std::string leon3_funcat_trap::READasr::getMnemonic() const throw(){
...
leon3_funcat_trap::READasr::READasr( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::WRITEY_reg::getInstructionName() const throw(){
    return "WRITEY_reg";
}

unsigned int leon3_funcat_trap::WRITEY_reg::getId() const throw(){
    return 130;
}
...
std::string leon3_funcat_trap::WRITEY_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::WRITEY_reg::WRITEY_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XNOR_reg::getInstructionName() const throw(){
    return "XNOR_reg";
}

unsigned int leon3_funcat_trap::XNOR_reg::getId() const throw(){
    return 58;
}
...
std::string leon3_funcat_trap::XNOR_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xnor r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::XNOR_reg::XNOR_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
...
std::string leon3_funcat_trap::ANDNcc_reg::getInstructionName() const throw(){
    return "ANDNcc_reg";
}

unsigned int leon3_funcat_trap::ANDNcc_reg::getId() const throw(){
    return 44;
}
...
std::string leon3_funcat_trap::ANDNcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andncc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ANDNcc_reg::ANDNcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSB_imm::getInstructionName() const throw(){
    return "LDSB_imm";
}

unsigned int leon3_funcat_trap::LDSB_imm::getId() const throw(){
    return 0;
}
...
std::string leon3_funcat_trap::LDSB_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldsb r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDSB_imm::LDSB_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::WRITEpsr_imm::getInstructionName() const throw(){
    return "WRITEpsr_imm";
}

unsigned int leon3_funcat_trap::WRITEpsr_imm::getId() const throw(){
    return 135;
}
...
std::string leon3_funcat_trap::WRITEpsr_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::WRITEpsr_imm::WRITEpsr_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::READy::getInstructionName() const throw(){
    return "READy";
}

unsigned int leon3_funcat_trap::READy::getId() const throw(){
    return 125;
}
...
std::string leon3_funcat_trap::READy::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rd ";
    oss << "y";
    oss << " r";
...
leon3_funcat_trap::READy::READy( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
...
std::string leon3_funcat_trap::XNORcc_reg::getInstructionName() const throw(){
    return "XNORcc_reg";
}

unsigned int leon3_funcat_trap::XNORcc_reg::getId() const throw(){
    return 60;
}
...
std::string leon3_funcat_trap::XNORcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xnorcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::XNORcc_reg::XNORcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::READpsr::getInstructionName() const throw(){
    return "READpsr";
}

unsigned int leon3_funcat_trap::READpsr::getId() const throw(){
    return 127;
}
...
std::string leon3_funcat_trap::READpsr::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rd ";
    oss << "psr r";
    oss << this->rd_bit;
...
leon3_funcat_trap::READpsr::READpsr( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ANDN_imm::getInstructionName() const throw(){
    return "ANDN_imm";
}

unsigned int leon3_funcat_trap::ANDN_imm::getId() const throw(){
    return 41;
}
...
std::string leon3_funcat_trap::ANDN_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andn r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ANDN_imm::ANDN_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ANDcc_reg::getInstructionName() const throw(){
    return "ANDcc_reg";
}

unsigned int leon3_funcat_trap::ANDcc_reg::getId() const throw(){
    return 40;
}
...
std::string leon3_funcat_trap::ANDcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ANDcc_reg::ANDcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TSUBcc_imm::getInstructionName() const throw(){
    return "TSUBcc_imm";
}

unsigned int leon3_funcat_trap::TSUBcc_imm::getId() const throw(){
    return 87;
}
...
std::string leon3_funcat_trap::TSUBcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "tsubcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::TSUBcc_imm::TSUBcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSBA_reg::getInstructionName() const throw(){
    return "LDSBA_reg";
}

unsigned int leon3_funcat_trap::LDSBA_reg::getId() const throw(){
    return 12;
}
...
std::string leon3_funcat_trap::LDSBA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldba r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSBA_reg::LDSBA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDUH_imm::getInstructionName() const throw(){
    return "LDUH_imm";
}

unsigned int leon3_funcat_trap::LDUH_imm::getId() const throw(){
    return 6;
}
...
std::string leon3_funcat_trap::LDUH_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "lduh r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDUH_imm::LDUH_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::STA_reg::getInstructionName() const throw(){
    return "STA_reg";
}

unsigned int leon3_funcat_trap::STA_reg::getId() const throw(){
    return 28;
}
...
std::string leon3_funcat_trap::STA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sta r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STA_reg::STA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ORN_reg::getInstructionName() const throw(){
    return "ORN_reg";
}

unsigned int leon3_funcat_trap::ORN_reg::getId() const throw(){
    return 50;
}
...
std::string leon3_funcat_trap::ORN_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orn r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ORN_reg::ORN_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSHA_reg::getInstructionName() const throw(){
    return "LDSHA_reg";
}

unsigned int leon3_funcat_trap::LDSHA_reg::getId() const throw(){
    return 13;
}
...
std::string leon3_funcat_trap::LDSHA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldsha r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSHA_reg::LDSHA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STBA_reg::getInstructionName() const throw(){
    return "STBA_reg";
}

unsigned int leon3_funcat_trap::STBA_reg::getId() const throw(){
    return 26;
}
...
std::string leon3_funcat_trap::STBA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "stba r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STBA_reg::STBA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ST_imm::getInstructionName() const throw(){
    return "ST_imm";
}

unsigned int leon3_funcat_trap::ST_imm::getId() const throw(){
    return 22;
}
...
std::string leon3_funcat_trap::ST_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "st r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::ST_imm::ST_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::READtbr::getInstructionName() const throw(){
    return "READtbr";
}

unsigned int leon3_funcat_trap::READtbr::getId() const throw(){
    return 129;
}
...
std::string leon3_funcat_trap::READtbr::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rd ";
    oss << "tbr r";
    oss << this->rd_bit;
...
leon3_funcat_trap::READtbr::READtbr( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::UDIVcc_imm::getInstructionName() const throw(){
    return "UDIVcc_imm";
}

unsigned int leon3_funcat_trap::UDIVcc_imm::getId() const throw(){
    return 109;
}
...
std::string leon3_funcat_trap::UDIVcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "udivcc";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::UDIVcc_imm::UDIVcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SWAPA_reg::getInstructionName() const throw(){
    return "SWAPA_reg";
}

unsigned int leon3_funcat_trap::SWAPA_reg::getId() const throw(){
    return 35;
}
...
std::string leon3_funcat_trap::SWAPA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "swapa r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::SWAPA_reg::SWAPA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADDXcc_imm::getInstructionName() const throw(){
    return "ADDXcc_imm";
}

unsigned int leon3_funcat_trap::ADDXcc_imm::getId() const throw(){
    return 73;
}
...
std::string leon3_funcat_trap::ADDXcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addxcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ADDXcc_imm::ADDXcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STB_imm::getInstructionName() const throw(){
    return "STB_imm";
}

unsigned int leon3_funcat_trap::STB_imm::getId() const throw(){
    return 18;
}
...
std::string leon3_funcat_trap::STB_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "stb r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STB_imm::STB_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SUBXcc_imm::getInstructionName() const throw(){
    return "SUBXcc_imm";
}

unsigned int leon3_funcat_trap::SUBXcc_imm::getId() const throw(){
    return 85;
}
...
std::string leon3_funcat_trap::SUBXcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subxcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SUBXcc_imm::SUBXcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STH_reg::getInstructionName() const throw(){
    return "STH_reg";
}

unsigned int leon3_funcat_trap::STH_reg::getId() const throw(){
    return 21;
}
...
std::string leon3_funcat_trap::STH_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sth r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STH_reg::STH_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SRL_imm::getInstructionName() const throw(){
    return "SRL_imm";
}

unsigned int leon3_funcat_trap::SRL_imm::getId() const throw(){
    return 63;
}
...
std::string leon3_funcat_trap::SRL_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "srl r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SRL_imm::SRL_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::WRITEasr_imm::getInstructionName() const throw(){
    return "WRITEasr_imm";
}

unsigned int leon3_funcat_trap::WRITEasr_imm::getId() const throw(){
    return 133;
}
...
std::string leon3_funcat_trap::WRITEasr_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::WRITEasr_imm::WRITEasr_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UMULcc_reg::getInstructionName() const throw(){
    return "UMULcc_reg";
}

unsigned int leon3_funcat_trap::UMULcc_reg::getId() const throw(){
    return 98;
}
...
std::string leon3_funcat_trap::UMULcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umulcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::UMULcc_reg::UMULcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSTUB_reg::getInstructionName() const throw(){
    return "LDSTUB_reg";
}

unsigned int leon3_funcat_trap::LDSTUB_reg::getId() const throw(){
    return 31;
}
...
std::string leon3_funcat_trap::LDSTUB_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldastub r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSTUB_reg::LDSTUB_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XOR_imm::getInstructionName() const throw(){
    return "XOR_imm";
}

unsigned int leon3_funcat_trap::XOR_imm::getId() const throw(){
    return 53;
}
...
std::string leon3_funcat_trap::XOR_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xor r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::XOR_imm::XOR_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SMAC_reg::getInstructionName() const throw(){
    return "SMAC_reg";
}

unsigned int leon3_funcat_trap::SMAC_reg::getId() const throw(){
    return 104;
}
...
std::string leon3_funcat_trap::SMAC_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smac r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SMAC_reg::SMAC_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::WRITEasr_reg::getInstructionName() const throw(){
    return "WRITEasr_reg";
}

unsigned int leon3_funcat_trap::WRITEasr_reg::getId() const throw(){
    return 132;
}
...
std::string leon3_funcat_trap::WRITEasr_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::WRITEasr_reg::WRITEasr_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LD_reg::getInstructionName() const throw(){
    return "LD_reg";
}

unsigned int leon3_funcat_trap::LD_reg::getId() const throw(){
    return 9;
}
...
std::string leon3_funcat_trap::LD_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ld r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LD_reg::LD_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ST_reg::getInstructionName() const throw(){
    return "ST_reg";
}

unsigned int leon3_funcat_trap::ST_reg::getId() const throw(){
    return 23;
}
...
std::string leon3_funcat_trap::ST_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "st r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::ST_reg::ST_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SUBcc_reg::getInstructionName() const throw(){
    return "SUBcc_reg";
}

unsigned int leon3_funcat_trap::SUBcc_reg::getId() const throw(){
    return 82;
}
...
std::string leon3_funcat_trap::SUBcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SUBcc_reg::SUBcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDD_reg::getInstructionName() const throw(){
    return "LDD_reg";
}

unsigned int leon3_funcat_trap::LDD_reg::getId() const throw(){
    return 11;
}
...
std::string leon3_funcat_trap::LDD_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldd r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDD_reg::LDD_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ADDcc_imm::getInstructionName() const throw(){
    return "ADDcc_imm";
}

unsigned int leon3_funcat_trap::ADDcc_imm::getId() const throw(){
    return 69;
}
...
std::string leon3_funcat_trap::ADDcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ADDcc_imm::ADDcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDUH_reg::getInstructionName() const throw(){
    return "LDUH_reg";
}

unsigned int leon3_funcat_trap::LDUH_reg::getId() const throw(){
    return 7;
}
...
std::string leon3_funcat_trap::LDUH_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "lduh r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDUH_reg::LDUH_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SRL_reg::getInstructionName() const throw(){
    return "SRL_reg";
}

unsigned int leon3_funcat_trap::SRL_reg::getId() const throw(){
    return 64;
}
...
std::string leon3_funcat_trap::SRL_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "srl r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SRL_reg::SRL_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SAVE_imm::getInstructionName() const throw(){
    return "SAVE_imm";
}

unsigned int leon3_funcat_trap::SAVE_imm::getId() const throw(){
    return 113;
}
...
std::string leon3_funcat_trap::SAVE_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "save";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SAVE_imm::SAVE_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::MULScc_reg::getInstructionName() const throw(){
    return "MULScc_reg";
}

unsigned int leon3_funcat_trap::MULScc_reg::getId() const throw(){
    return 92;
}
...
std::string leon3_funcat_trap::MULScc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "mulscc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::MULScc_reg::MULScc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::OR_imm::getInstructionName() const throw(){
    return "OR_imm";
}

unsigned int leon3_funcat_trap::OR_imm::getId() const throw(){
    return 45;
}
...
std::string leon3_funcat_trap::OR_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "or r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::OR_imm::OR_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STD_imm::getInstructionName() const throw(){
    return "STD_imm";
}

unsigned int leon3_funcat_trap::STD_imm::getId() const throw(){
    return 24;
}
...
std::string leon3_funcat_trap::STD_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "std r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STD_imm::STD_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SUBXcc_reg::getInstructionName() const throw(){
    return "SUBXcc_reg";
}

unsigned int leon3_funcat_trap::SUBXcc_reg::getId() const throw(){
    return 86;
}
...
std::string leon3_funcat_trap::SUBXcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subxcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SUBXcc_reg::SUBXcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADDX_imm::getInstructionName() const throw(){
    return "ADDX_imm";
}

unsigned int leon3_funcat_trap::ADDX_imm::getId() const throw(){
    return 71;
}
...
std::string leon3_funcat_trap::ADDX_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addx r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ADDX_imm::ADDX_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SWAP_imm::getInstructionName() const throw(){
    return "SWAP_imm";
}

unsigned int leon3_funcat_trap::SWAP_imm::getId() const throw(){
    return 33;
}
...
std::string leon3_funcat_trap::SWAP_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "swap r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::SWAP_imm::SWAP_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::UMUL_reg::getInstructionName() const throw(){
    return "UMUL_reg";
}

unsigned int leon3_funcat_trap::UMUL_reg::getId() const throw(){
    return 94;
}
...
std::string leon3_funcat_trap::UMUL_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umul r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::UMUL_reg::UMUL_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::WRITEY_imm::getInstructionName() const throw(){
    return "WRITEY_imm";
}

unsigned int leon3_funcat_trap::WRITEY_imm::getId() const throw(){
    return 131;
}
...
std::string leon3_funcat_trap::WRITEY_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::WRITEY_imm::WRITEY_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::AND_reg::getInstructionName() const throw(){
    return "AND_reg";
}

unsigned int leon3_funcat_trap::AND_reg::getId() const throw(){
    return 38;
}
...
std::string leon3_funcat_trap::AND_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "and r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::AND_reg::AND_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::FLUSH_imm::getInstructionName() const throw(){
    return "FLUSH_imm";
}

unsigned int leon3_funcat_trap::FLUSH_imm::getId() const throw(){
    return 143;
}
...
std::string leon3_funcat_trap::FLUSH_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "flush r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::FLUSH_imm::FLUSH_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SRA_reg::getInstructionName() const throw(){
    return "SRA_reg";
}

unsigned int leon3_funcat_trap::SRA_reg::getId() const throw(){
    return 66;
}
...
std::string leon3_funcat_trap::SRA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sra r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SRA_reg::SRA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STH_imm::getInstructionName() const throw(){
    return "STH_imm";
}

unsigned int leon3_funcat_trap::STH_imm::getId() const throw(){
    return 20;
}
...
std::string leon3_funcat_trap::STH_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sth r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STH_imm::STH_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::WRITEwim_imm::getInstructionName() const throw(){
    return "WRITEwim_imm";
}

unsigned int leon3_funcat_trap::WRITEwim_imm::getId() const throw(){
    return 137;
}
...
std::string leon3_funcat_trap::WRITEwim_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::WRITEwim_imm::WRITEwim_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDD_imm::getInstructionName() const throw(){
    return "LDD_imm";
}

unsigned int leon3_funcat_trap::LDD_imm::getId() const throw(){
    return 10;
}
...
std::string leon3_funcat_trap::LDD_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldd r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDD_imm::LDD_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SLL_imm::getInstructionName() const throw(){
    return "SLL_imm";
}

unsigned int leon3_funcat_trap::SLL_imm::getId() const throw(){
    return 61;
}
...
std::string leon3_funcat_trap::SLL_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sll r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SLL_imm::SLL_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDUHA_reg::getInstructionName() const throw(){
    return "LDUHA_reg";
}

unsigned int leon3_funcat_trap::LDUHA_reg::getId() const throw(){
    return 15;
}
...
std::string leon3_funcat_trap::LDUHA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "lduha r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDUHA_reg::LDUHA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TADDcc_reg::getInstructionName() const throw(){
    return "TADDcc_reg";
}

unsigned int leon3_funcat_trap::TADDcc_reg::getId() const throw(){
    return 76;
}
...
std::string leon3_funcat_trap::TADDcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "taddcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::TADDcc_reg::TADDcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TADDcc_imm::getInstructionName() const throw(){
    return "TADDcc_imm";
}

unsigned int leon3_funcat_trap::TADDcc_imm::getId() const throw(){
    return 75;
}
...
std::string leon3_funcat_trap::TADDcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "taddcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::TADDcc_imm::TADDcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SDIV_imm::getInstructionName() const throw(){
    return "SDIV_imm";
}

unsigned int leon3_funcat_trap::SDIV_imm::getId() const throw(){
    return 107;
}
...
std::string leon3_funcat_trap::SDIV_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sdiv";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SDIV_imm::SDIV_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TSUBccTV_imm::getInstructionName() const throw(){
    return "TSUBccTV_imm";
}

unsigned int leon3_funcat_trap::TSUBccTV_imm::getId() const throw(){
    return 89;
}
...
std::string leon3_funcat_trap::TSUBccTV_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "tsubcctv r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::TSUBccTV_imm::TSUBccTV_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::FLUSH_reg::getInstructionName() const throw(){
    return "FLUSH_reg";
}

unsigned int leon3_funcat_trap::FLUSH_reg::getId() const throw(){
    return 142;
}
...
std::string leon3_funcat_trap::FLUSH_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "flush r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::FLUSH_reg::FLUSH_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ORNcc_reg::getInstructionName() const throw(){
    return "ORNcc_reg";
}

unsigned int leon3_funcat_trap::ORNcc_reg::getId() const throw(){
    return 52;
}
...
std::string leon3_funcat_trap::ORNcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orncc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ORNcc_reg::ORNcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::RETT_imm::getInstructionName() const throw(){
    return "RETT_imm";
}

unsigned int leon3_funcat_trap::RETT_imm::getId() const throw(){
    return 121;
}
...
std::string leon3_funcat_trap::RETT_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rett r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::RETT_imm::RETT_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SDIVcc_reg::getInstructionName() const throw(){
    return "SDIVcc_reg";
}

unsigned int leon3_funcat_trap::SDIVcc_reg::getId() const throw(){
    return 112;
}
...
std::string leon3_funcat_trap::SDIVcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sdivcc";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SDIVcc_reg::SDIVcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADD_reg::getInstructionName() const throw(){
    return "ADD_reg";
}

unsigned int leon3_funcat_trap::ADD_reg::getId() const throw(){
    return 68;
}
...
std::string leon3_funcat_trap::ADD_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "add r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ADD_reg::ADD_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TRAP_imm::getInstructionName() const throw(){
    return "TRAP_imm";
}

unsigned int leon3_funcat_trap::TRAP_imm::getId() const throw(){
    return 123;
}
...
std::string leon3_funcat_trap::TRAP_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "t";
    switch(this->cond){
        case 0:{
...
leon3_funcat_trap::TRAP_imm::TRAP_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::WRITEtbr_imm::getInstructionName() const throw(){
    return "WRITEtbr_imm";
}

unsigned int leon3_funcat_trap::WRITEtbr_imm::getId() const throw(){
    return 139;
}
...
std::string leon3_funcat_trap::WRITEtbr_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::WRITEtbr_imm::WRITEtbr_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDUB_reg::getInstructionName() const throw(){
    return "LDUB_reg";
}

unsigned int leon3_funcat_trap::LDUB_reg::getId() const throw(){
    return 5;
}
...
std::string leon3_funcat_trap::LDUB_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldub r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDUB_reg::LDUB_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::RESTORE_reg::getInstructionName() const throw(){
    return "RESTORE_reg";
}

unsigned int leon3_funcat_trap::RESTORE_reg::getId() const throw(){
    return 116;
}
...
std::string leon3_funcat_trap::RESTORE_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "restore";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::RESTORE_reg::RESTORE_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADDXcc_reg::getInstructionName() const throw(){
    return "ADDXcc_reg";
}

unsigned int leon3_funcat_trap::ADDXcc_reg::getId() const throw(){
    return 74;
}
...
std::string leon3_funcat_trap::ADDXcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addxcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ADDXcc_reg::ADDXcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STB_reg::getInstructionName() const throw(){
    return "STB_reg";
}

unsigned int leon3_funcat_trap::STB_reg::getId() const throw(){
    return 19;
}
...
std::string leon3_funcat_trap::STB_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "stb r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STB_reg::STB_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::AND_imm::getInstructionName() const throw(){
    return "AND_imm";
}

unsigned int leon3_funcat_trap::AND_imm::getId() const throw(){
    return 37;
}
...
std::string leon3_funcat_trap::AND_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "and r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::AND_imm::AND_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SMUL_imm::getInstructionName() const throw(){
    return "SMUL_imm";
}

unsigned int leon3_funcat_trap::SMUL_imm::getId() const throw(){
    return 95;
}
...
std::string leon3_funcat_trap::SMUL_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smul r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SMUL_imm::SMUL_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADD_imm::getInstructionName() const throw(){
    return "ADD_imm";
}

unsigned int leon3_funcat_trap::ADD_imm::getId() const throw(){
    return 67;
}
...
std::string leon3_funcat_trap::ADD_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "add r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ADD_imm::ADD_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UMUL_imm::getInstructionName() const throw(){
    return "UMUL_imm";
}

unsigned int leon3_funcat_trap::UMUL_imm::getId() const throw(){
    return 93;
}
...
std::string leon3_funcat_trap::UMUL_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umul r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::UMUL_imm::UMUL_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::READwim::getInstructionName() const throw(){
    return "READwim";
}

unsigned int leon3_funcat_trap::READwim::getId() const throw(){
    return 128;
}
...
std::string leon3_funcat_trap::READwim::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rd ";
    oss << "wim r";
    oss << this->rd_bit;
...
leon3_funcat_trap::READwim::READwim( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::LDSTUB_imm::getInstructionName() const throw(){
    return "LDSTUB_imm";
}

unsigned int leon3_funcat_trap::LDSTUB_imm::getId() const throw(){
    return 30;
}
...
std::string leon3_funcat_trap::LDSTUB_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldastub r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDSTUB_imm::LDSTUB_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SMAC_imm::getInstructionName() const throw(){
    return "SMAC_imm";
}

unsigned int leon3_funcat_trap::SMAC_imm::getId() const throw(){
    return 103;
}
...
std::string leon3_funcat_trap::SMAC_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smac r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SMAC_imm::SMAC_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSB_reg::getInstructionName() const throw(){
    return "LDSB_reg";
}

unsigned int leon3_funcat_trap::LDSB_reg::getId() const throw(){
    return 1;
}
...
std::string leon3_funcat_trap::LDSB_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldsb r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSB_reg::LDSB_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ANDN_reg::getInstructionName() const throw(){
    return "ANDN_reg";
}

unsigned int leon3_funcat_trap::ANDN_reg::getId() const throw(){
    return 42;
}
...
std::string leon3_funcat_trap::ANDN_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andn r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ANDN_reg::ANDN_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TSUBccTV_reg::getInstructionName() const throw(){
    return "TSUBccTV_reg";
}

unsigned int leon3_funcat_trap::TSUBccTV_reg::getId() const throw(){
    return 90;
}
...
std::string leon3_funcat_trap::TSUBccTV_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "tsubcctv r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::TSUBccTV_reg::TSUBccTV_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SETHI::getInstructionName() const throw(){
    return "SETHI";
}

unsigned int leon3_funcat_trap::SETHI::getId() const throw(){
    return 36;
}
...
std::string leon3_funcat_trap::SETHI::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sethi ";
    oss << this->imm22;
    oss << " r";
...
leon3_funcat_trap::SETHI::SETHI( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SRA_imm::getInstructionName() const throw(){
    return "SRA_imm";
}

unsigned int leon3_funcat_trap::SRA_imm::getId() const throw(){
    return 65;
}
...
std::string leon3_funcat_trap::SRA_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sra r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SRA_imm::SRA_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSH_reg::getInstructionName() const throw(){
    return "LDSH_reg";
}

unsigned int leon3_funcat_trap::LDSH_reg::getId() const throw(){
    return 3;
}
...
std::string leon3_funcat_trap::LDSH_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldsh r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSH_reg::LDSH_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::UDIVcc_reg::getInstructionName() const throw(){
    return "UDIVcc_reg";
}

unsigned int leon3_funcat_trap::UDIVcc_reg::getId() const throw(){
    return 110;
}
...
std::string leon3_funcat_trap::UDIVcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "udivcc";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::UDIVcc_reg::UDIVcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ORN_imm::getInstructionName() const throw(){
    return "ORN_imm";
}

unsigned int leon3_funcat_trap::ORN_imm::getId() const throw(){
    return 49;
}
...
std::string leon3_funcat_trap::ORN_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orn r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ORN_imm::ORN_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STD_reg::getInstructionName() const throw(){
    return "STD_reg";
}

unsigned int leon3_funcat_trap::STD_reg::getId() const throw(){
    return 25;
}
...
std::string leon3_funcat_trap::STD_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "std r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STD_reg::STD_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ANDNcc_imm::getInstructionName() const throw(){
    return "ANDNcc_imm";
}

unsigned int leon3_funcat_trap::ANDNcc_imm::getId() const throw(){
    return 43;
}
...
std::string leon3_funcat_trap::ANDNcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andncc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ANDNcc_imm::ANDNcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TADDccTV_imm::getInstructionName() const throw(){
    return "TADDccTV_imm";
}

unsigned int leon3_funcat_trap::TADDccTV_imm::getId() const throw(){
    return 77;
}
...
std::string leon3_funcat_trap::TADDccTV_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "taddcctv r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::TADDccTV_imm::TADDccTV_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::WRITEtbr_reg::getInstructionName() const throw(){
    return "WRITEtbr_reg";
}

unsigned int leon3_funcat_trap::WRITEtbr_reg::getId() const throw(){
    return 138;
}
...
std::string leon3_funcat_trap::WRITEtbr_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::WRITEtbr_reg::WRITEtbr_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SUBX_reg::getInstructionName() const throw(){
    return "SUBX_reg";
}

unsigned int leon3_funcat_trap::SUBX_reg::getId() const throw(){
    return 84;
}
...
std::string leon3_funcat_trap::SUBX_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subx r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SUBX_reg::SUBX_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XNOR_imm::getInstructionName() const throw(){
    return "XNOR_imm";
}

unsigned int leon3_funcat_trap::XNOR_imm::getId() const throw(){
    return 57;
}
...
std::string leon3_funcat_trap::XNOR_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xnor r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::XNOR_imm::XNOR_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UDIV_imm::getInstructionName() const throw(){
    return "UDIV_imm";
}

unsigned int leon3_funcat_trap::UDIV_imm::getId() const throw(){
    return 105;
}
...
std::string leon3_funcat_trap::UDIV_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "udiv";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::UDIV_imm::UDIV_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDSH_imm::getInstructionName() const throw(){
    return "LDSH_imm";
}

unsigned int leon3_funcat_trap::LDSH_imm::getId() const throw(){
    return 2;
}
...
std::string leon3_funcat_trap::LDSH_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldsh r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDSH_imm::LDSH_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::UNIMP::getInstructionName() const throw(){
    return "UNIMP";
}

unsigned int leon3_funcat_trap::UNIMP::getId() const throw(){
    return 141;
}
...
std::string leon3_funcat_trap::UNIMP::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "unimp ";
    oss << this->imm22;
    return oss.str();
...
leon3_funcat_trap::UNIMP::UNIMP( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::LDSTUBA_reg::getInstructionName() const throw(){
    return "LDSTUBA_reg";
}

unsigned int leon3_funcat_trap::LDSTUBA_reg::getId() const throw(){
    return 32;
}
...
std::string leon3_funcat_trap::LDSTUBA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldastub r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDSTUBA_reg::LDSTUBA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UMULcc_imm::getInstructionName() const throw(){
    return "UMULcc_imm";
}

unsigned int leon3_funcat_trap::UMULcc_imm::getId() const throw(){
    return 97;
}
...
std::string leon3_funcat_trap::UMULcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umulcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::UMULcc_imm::UMULcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ORcc_reg::getInstructionName() const throw(){
    return "ORcc_reg";
}

unsigned int leon3_funcat_trap::ORcc_reg::getId() const throw(){
    return 48;
}
...
std::string leon3_funcat_trap::ORcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ORcc_reg::ORcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::MULScc_imm::getInstructionName() const throw(){
    return "MULScc_imm";
}

unsigned int leon3_funcat_trap::MULScc_imm::getId() const throw(){
    return 91;
}
...
std::string leon3_funcat_trap::MULScc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "mulscc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::MULScc_imm::MULScc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XORcc_reg::getInstructionName() const throw(){
    return "XORcc_reg";
}

unsigned int leon3_funcat_trap::XORcc_reg::getId() const throw(){
    return 56;
}
...
std::string leon3_funcat_trap::XORcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xorcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::XORcc_reg::XORcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SUB_reg::getInstructionName() const throw(){
    return "SUB_reg";
}

unsigned int leon3_funcat_trap::SUB_reg::getId() const throw(){
    return 80;
}
...
std::string leon3_funcat_trap::SUB_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sub r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SUB_reg::SUB_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::WRITEwim_reg::getInstructionName() const throw(){
    return "WRITEwim_reg";
}

unsigned int leon3_funcat_trap::WRITEwim_reg::getId() const throw(){
    return 136;
}
...
std::string leon3_funcat_trap::WRITEwim_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::WRITEwim_reg::WRITEwim_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UMAC_imm::getInstructionName() const throw(){
    return "UMAC_imm";
}

unsigned int leon3_funcat_trap::UMAC_imm::getId() const throw(){
    return 101;
}
...
std::string leon3_funcat_trap::UMAC_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umac r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::UMAC_imm::UMAC_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TSUBcc_reg::getInstructionName() const throw(){
    return "TSUBcc_reg";
}

unsigned int leon3_funcat_trap::TSUBcc_reg::getId() const throw(){
    return 88;
}
...
std::string leon3_funcat_trap::TSUBcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "tsubcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::TSUBcc_reg::TSUBcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::BRANCH::getInstructionName() const throw(){
    return "BRANCH";
}

unsigned int leon3_funcat_trap::BRANCH::getId() const throw(){
    return 117;
}
...
std::string leon3_funcat_trap::BRANCH::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "b";
    switch(this->cond){
        case 0:{
...
leon3_funcat_trap::BRANCH::BRANCH( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SMULcc_reg::getInstructionName() const throw(){
    return "SMULcc_reg";
}

unsigned int leon3_funcat_trap::SMULcc_reg::getId() const throw(){
    return 100;
}
...
std::string leon3_funcat_trap::SMULcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smulcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SMULcc_reg::SMULcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SUB_imm::getInstructionName() const throw(){
    return "SUB_imm";
}

unsigned int leon3_funcat_trap::SUB_imm::getId() const throw(){
    return 79;
}
...
std::string leon3_funcat_trap::SUB_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sub r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SUB_imm::SUB_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ADDcc_reg::getInstructionName() const throw(){
    return "ADDcc_reg";
}

unsigned int leon3_funcat_trap::ADDcc_reg::getId() const throw(){
    return 70;
}
...
std::string leon3_funcat_trap::ADDcc_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addcc r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ADDcc_reg::ADDcc_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XOR_reg::getInstructionName() const throw(){
    return "XOR_reg";
}

unsigned int leon3_funcat_trap::XOR_reg::getId() const throw(){
    return 54;
}
...
std::string leon3_funcat_trap::XOR_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xor r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::XOR_reg::XOR_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SUBcc_imm::getInstructionName() const throw(){
    return "SUBcc_imm";
}

unsigned int leon3_funcat_trap::SUBcc_imm::getId() const throw(){
    return 81;
}
...
std::string leon3_funcat_trap::SUBcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SUBcc_imm::SUBcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::TADDccTV_reg::getInstructionName() const throw(){
    return "TADDccTV_reg";
}

unsigned int leon3_funcat_trap::TADDccTV_reg::getId() const throw(){
    return 78;
}
...
std::string leon3_funcat_trap::TADDccTV_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "taddcctv r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::TADDccTV_reg::TADDccTV_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SDIV_reg::getInstructionName() const throw(){
    return "SDIV_reg";
}

unsigned int leon3_funcat_trap::SDIV_reg::getId() const throw(){
    return 108;
}
...
std::string leon3_funcat_trap::SDIV_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sdiv";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SDIV_reg::SDIV_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SMULcc_imm::getInstructionName() const throw(){
    return "SMULcc_imm";
}

unsigned int leon3_funcat_trap::SMULcc_imm::getId() const throw(){
    return 99;
}
...
std::string leon3_funcat_trap::SMULcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smulcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SMULcc_imm::SMULcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SWAP_reg::getInstructionName() const throw(){
    return "SWAP_reg";
}

unsigned int leon3_funcat_trap::SWAP_reg::getId() const throw(){
    return 34;
}
...
std::string leon3_funcat_trap::SWAP_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "swap r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::SWAP_reg::SWAP_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SUBX_imm::getInstructionName() const throw(){
    return "SUBX_imm";
}

unsigned int leon3_funcat_trap::SUBX_imm::getId() const throw(){
    return 83;
}
...
std::string leon3_funcat_trap::SUBX_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "subx r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::SUBX_imm::SUBX_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STDA_reg::getInstructionName() const throw(){
    return "STDA_reg";
}

unsigned int leon3_funcat_trap::STDA_reg::getId() const throw(){
    return 29;
}
...
std::string leon3_funcat_trap::STDA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "stda r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STDA_reg::STDA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::UMAC_reg::getInstructionName() const throw(){
    return "UMAC_reg";
}

unsigned int leon3_funcat_trap::UMAC_reg::getId() const throw(){
    return 102;
}
...
std::string leon3_funcat_trap::UMAC_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "umac r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::UMAC_reg::UMAC_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::JUMP_imm::getInstructionName() const throw(){
    return "JUMP_imm";
}

unsigned int leon3_funcat_trap::JUMP_imm::getId() const throw(){
    return 119;
}
...
std::string leon3_funcat_trap::JUMP_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "jmpl";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::JUMP_imm::JUMP_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SMUL_reg::getInstructionName() const throw(){
    return "SMUL_reg";
}

unsigned int leon3_funcat_trap::SMUL_reg::getId() const throw(){
    return 96;
}
...
std::string leon3_funcat_trap::SMUL_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "smul r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SMUL_reg::SMUL_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XORcc_imm::getInstructionName() const throw(){
    return "XORcc_imm";
}

unsigned int leon3_funcat_trap::XORcc_imm::getId() const throw(){
    return 55;
}
...
std::string leon3_funcat_trap::XORcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xorcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::XORcc_imm::XORcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ORNcc_imm::getInstructionName() const throw(){
    return "ORNcc_imm";
}

unsigned int leon3_funcat_trap::ORNcc_imm::getId() const throw(){
    return 51;
}
...
std::string leon3_funcat_trap::ORNcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orncc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ORNcc_imm::ORNcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LDUBA_reg::getInstructionName() const throw(){
    return "LDUBA_reg";
}

unsigned int leon3_funcat_trap::LDUBA_reg::getId() const throw(){
    return 14;
}
...
std::string leon3_funcat_trap::LDUBA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "lduba r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDUBA_reg::LDUBA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::JUMP_reg::getInstructionName() const throw(){
    return "JUMP_reg";
}

unsigned int leon3_funcat_trap::JUMP_reg::getId() const throw(){
    return 120;
}
...
std::string leon3_funcat_trap::JUMP_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "jmpl";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::JUMP_reg::JUMP_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::ADDX_reg::getInstructionName() const throw(){
    return "ADDX_reg";
}

unsigned int leon3_funcat_trap::ADDX_reg::getId() const throw(){
    return 72;
}
...
std::string leon3_funcat_trap::ADDX_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "addx r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::ADDX_reg::ADDX_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::UDIV_reg::getInstructionName() const throw(){
    return "UDIV_reg";
}

unsigned int leon3_funcat_trap::UDIV_reg::getId() const throw(){
    return 106;
}
...
std::string leon3_funcat_trap::UDIV_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "udiv";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::UDIV_reg::UDIV_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::XNORcc_imm::getInstructionName() const throw(){
    return "XNORcc_imm";
}

unsigned int leon3_funcat_trap::XNORcc_imm::getId() const throw(){
    return 59;
}
...
std::string leon3_funcat_trap::XNORcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "xnorcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::XNORcc_imm::XNORcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::STBAR::getInstructionName() const throw(){
    return "STBAR";
}

unsigned int leon3_funcat_trap::STBAR::getId() const throw(){
    return 140;
}
...
std::string leon3_funcat_trap::STBAR::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "s";
    oss << "t";
    oss << "b";
...
leon3_funcat_trap::STBAR::STBAR( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::LDA_reg::getInstructionName() const throw(){
    return "LDA_reg";
}

unsigned int leon3_funcat_trap::LDA_reg::getId() const throw(){
    return 16;
}
...
std::string leon3_funcat_trap::LDA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "lda r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDA_reg::LDA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::STHA_reg::getInstructionName() const throw(){
    return "STHA_reg";
}

unsigned int leon3_funcat_trap::STHA_reg::getId() const throw(){
    return 27;
}
...
std::string leon3_funcat_trap::STHA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "stha r";
    oss << this->rd_bit;
    oss << " r";
...
leon3_funcat_trap::STHA_reg::STHA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::LDDA_reg::getInstructionName() const throw(){
    return "LDDA_reg";
}

unsigned int leon3_funcat_trap::LDDA_reg::getId() const throw(){
    return 17;
}
...
std::string leon3_funcat_trap::LDDA_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldda r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::LDDA_reg::LDDA_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SLL_reg::getInstructionName() const throw(){
    return "SLL_reg";
}

unsigned int leon3_funcat_trap::SLL_reg::getId() const throw(){
    return 62;
}
...
std::string leon3_funcat_trap::SLL_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sll r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::SLL_reg::SLL_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::RESTORE_imm::getInstructionName() const throw(){
    return "RESTORE_imm";
}

unsigned int leon3_funcat_trap::RESTORE_imm::getId() const throw(){
    return 115;
}
...
std::string leon3_funcat_trap::RESTORE_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "restore";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::RESTORE_imm::RESTORE_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::LD_imm::getInstructionName() const throw(){
    return "LD_imm";
}

unsigned int leon3_funcat_trap::LD_imm::getId() const throw(){
    return 8;
}
...
std::string leon3_funcat_trap::LD_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ld r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LD_imm::LD_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::TRAP_reg::getInstructionName() const throw(){
    return "TRAP_reg";
}

unsigned int leon3_funcat_trap::TRAP_reg::getId() const throw(){
    return 124;
}
...
std::string leon3_funcat_trap::TRAP_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "t";
    switch(this->cond){
        case 0:{
...
leon3_funcat_trap::TRAP_reg::TRAP_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::LDUB_imm::getInstructionName() const throw(){
    return "LDUB_imm";
}

unsigned int leon3_funcat_trap::LDUB_imm::getId() const throw(){
    return 4;
}
...
std::string leon3_funcat_trap::LDUB_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "ldub r";
    oss << this->rs1_bit;
    oss << "+";
...
leon3_funcat_trap::LDUB_imm::LDUB_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::RETT_reg::getInstructionName() const throw(){
    return "RETT_reg";
}

unsigned int leon3_funcat_trap::RETT_reg::getId() const throw(){
    return 122;
}
...
std::string leon3_funcat_trap::RETT_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "rett r";
    oss << this->rs1_bit;
    oss << "+r";
...
leon3_funcat_trap::RETT_reg::RETT_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::SDIVcc_imm::getInstructionName() const throw(){
    return "SDIVcc_imm";
}

unsigned int leon3_funcat_trap::SDIVcc_imm::getId() const throw(){
    return 111;
}
...
std::string leon3_funcat_trap::SDIVcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "sdivcc";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SDIVcc_imm::SDIVcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::SAVE_reg::getInstructionName() const throw(){
    return "SAVE_reg";
}

unsigned int leon3_funcat_trap::SAVE_reg::getId() const throw(){
    return 114;
}
...
std::string leon3_funcat_trap::SAVE_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "save";
    oss << " r";
    oss << this->rs1_bit;
...
leon3_funcat_trap::SAVE_reg::SAVE_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::OR_reg::getInstructionName() const throw(){
    return "OR_reg";
}

unsigned int leon3_funcat_trap::OR_reg::getId() const throw(){
    return 46;
}
...
std::string leon3_funcat_trap::OR_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "or r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::OR_reg::OR_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ORcc_imm::getInstructionName() const throw(){
    return "ORcc_imm";
}

unsigned int leon3_funcat_trap::ORcc_imm::getId() const throw(){
    return 47;
}
...
std::string leon3_funcat_trap::ORcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "orcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ORcc_imm::ORcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, \
    Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::CALL::getInstructionName() const throw(){
    return "CALL";
}

unsigned int leon3_funcat_trap::CALL::getId() const throw(){
    return 118;
}
...
std::string leon3_funcat_trap::CALL::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "call ";
    oss << this->disp30;
    return oss.str();
...
leon3_funcat_trap::CALL::CALL( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & TBR, Reg32_3 \
    & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 * WINREGS, \
    Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias * REGS, TLMMemory \
    & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, WIM, \
    TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, irqAck){
...
std::string leon3_funcat_trap::WRITEpsr_reg::getInstructionName() const throw(){
    return "WRITEpsr_reg";
}

unsigned int leon3_funcat_trap::WRITEpsr_reg::getId() const throw(){
    return 134;
}
...
std::string leon3_funcat_trap::WRITEpsr_reg::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "wr r";
    oss << this->rs1_bit;
    oss << " r";
...
leon3_funcat_trap::WRITEpsr_reg::WRITEpsr_reg( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 \
    & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
std::string leon3_funcat_trap::ANDcc_imm::getInstructionName() const throw(){
    return "ANDcc_imm";
}

unsigned int leon3_funcat_trap::ANDcc_imm::getId() const throw(){
    return 39;
}
...
std::string leon3_funcat_trap::ANDcc_imm::getMnemonic() const throw(){
    std::ostringstream oss (std::ostringstream::out);
    oss << "andcc r";
    oss << this->rs1_bit;
    oss << " ";
...
leon3_funcat_trap::ANDcc_imm::ANDcc_imm( Reg32_0 & PSR, Reg32_1 & WIM, Reg32_2 & \
    TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass & GLOBAL, Reg32_3 \
    * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias & PCR, Alias \
    * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck ) : Instruction(PSR, \
    WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, LR, SP, PCR, REGS, instrMem, dataMem, \
...
unsigned int leon3_funcat_trap::IRQ_IRQ_Instruction::behavior(){
    this->totalInstrCycles = 0;
...
Instruction * leon3_funcat_trap::IRQ_IRQ_Instruction::replicate() const throw(){
    return new IRQ_IRQ_Instruction(PSR, WIM, TBR, Y, PC, NPC, GLOBAL, WINREGS, ASR, FP, \
        LR, SP, PCR, REGS, instrMem, dataMem, irqAck, this->IRQ);
}

void leon3_funcat_trap::IRQ_IRQ_Instruction::setParams( const unsigned int & bitString \
    ) throw(){

}

std::string leon3_funcat_trap::IRQ_IRQ_Instruction::getInstructionName() const throw(){
    return "IRQ_IRQ_Instruction";
}

std::string leon3_funcat_trap::IRQ_IRQ_Instruction::getMnemonic() const throw(){
    return "irq_IRQ";
}

unsigned int leon3_funcat_trap::IRQ_IRQ_Instruction::getId() const throw(){
    return (unsigned int)-1;
}

leon3_funcat_trap::IRQ_IRQ_Instruction::IRQ_IRQ_Instruction( Reg32_0 & PSR, Reg32_1 \
    & WIM, Reg32_2 & TBR, Reg32_3 & Y, Reg32_3 & PC, Reg32_3 & NPC, RegisterBankClass \
    & GLOBAL, Reg32_3 * WINREGS, Reg32_3 * ASR, Alias & FP, Alias & LR, Alias & SP, Alias \
    & PCR, Alias * REGS, TLMMemory & instrMem, TLMMemory & dataMem, PinTLM_out_32 & irqAck, \
...
leon3_funcat_trap::IRQ_IRQ_Instruction::~IRQ_IRQ_Instruction(){
