...
void testbench::initiator_thread(void) {
    ...
    while (1) {
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 4. Initialize main memory ((write miss) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 5. Fill line 0 of one of the sets (atag 1 - read miss) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 6. Read again with index 0 and atag 1 (atag 1 - read hit) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name() << " The data has been buffered in set: "
                << set_under_test << v::endl;
        ...
        for (unsigned int i = 0; i < 8; i++) {
            ...
            data = dread(((set_under_test << 16) | (i << 2)), 4, 0xf, 0, 0, 0,
                    debug);
            assert(data == i);
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 9. Read line with tag 2 -> fill the second set (cache miss)"
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 10. Invalidate set_under_test, line 0 subblock 3 "
                << v::endl;
        ...
        dwrite((set_under_test << 16), ((1 << 10) | 0xf7), 4, 0xe, 0, 0, 0,
                debug);
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 11. Read tag 3, line 0, subblock 3  "
                << v::endl;
        v::info << name()
                << " * This should give line 0 in set_under_test a new tag  "
                << v::endl;
        v::info << name()
                << " * and invalidate the old data (all entries except subblock 3)."
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 14. Fill line 0 of one of the sets (atag 1 - read miss) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 15. Read again with index 0 and atag 1 (atag 1 - read hit) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " The data (instructions) has been buffered in set: "
                << set_under_test << v::endl;
        ...
        for (unsigned int i = 0; i < 8; i++) {
            ...
            data = dread(((set_under_test << 16) | (i << 2)), 4, 0xd, 0, 0, 0,
                    debug);
            assert(data == i);
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 18. Read line with tag 2 -> fill the second set (cache miss)"
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 19. Invalidate set_under_test, line 0, subblock 3 "
                << v::endl;
        v::info << name() << " * (by diagnostic write)" << v::endl;
        v::info << name()
                << " ************************************************************"
        ...
        // TAG address = SET & LINE [15-5] & SUBBLOCK [4-2] & "00"
        // DATA = ATAG [26..10], LRR [9], LOCK [9], VALID [7..0]
        dwrite((set_under_test << 16), ((1 << 10) | 0xf7), 4, 0xc, 0, 0, 0,
                debug);
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 20. Read instruction cache with tag 3, line 0, subblock 3  "
                << v::endl;
        v::info << name()
                << " * This should give line 0 in set_under_test a new tag  "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 23. Load data to line 5 of both cache sets (tag 1, tag2) "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * Phase 4: Test instruction burst-fetch mode "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 23. Set cache control register to instr. burst fetch  "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 24. Invalidate instruction cache set 0  "
                << v::endl;
        v::info << name() << " * by deleting cache tag and valid bits "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 25. Instruction read with tag 1, line 0, offset 2.  "
                << v::endl;
        v::info << name()
                << " * This should cause the cache line to fill from subblock 2 "
                << v::endl;
