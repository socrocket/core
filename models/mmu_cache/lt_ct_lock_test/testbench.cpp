...
void testbench::initiator_thread(void) {
  ...
  while(1) {
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * Phase 1: Test LRU on DCACHE ");
    DUMP(name()," ************************************************************");

    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 4. Initialize main memory ");
    DUMP(name()," ************************************************************");
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 5. Fill line 3 offset 2 of set 1, 2, and 3 ");
    DUMP(name()," ************************************************************");
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 6. Check if the data was cached correctly ");
    DUMP(name()," ************************************************************");
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 7. Check LRU - The sets should be replaced in the same ");
    DUMP(name()," *    order they have been written in 6.");
    DUMP(name()," ************************************************************");
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * Phase 2: Test LRR on ICACHE ");
    DUMP(name()," ************************************************************");

    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 8. Fill line 3 offset 2 of set 1 and 2 ");
    DUMP(name()," ************************************************************");    
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 9. Check if the data was cached correctly ");
    DUMP(name()," ************************************************************");
    ...
    DUMP(name()," ************************************************************ ");
    DUMP(name()," * 10. Check LRR - The sets should be replaced in the same ");
    DUMP(name()," *     order they have been written in 6.");
    DUMP(name()," ************************************************************");
