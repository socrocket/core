...
void testbench::initiator_thread(void) {
    ...
    while (1) {
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 5. Fill line 3 offset 2 of set 1, 2, and 3 "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 6. Check if the data was cached correctly "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 7. Check LRU - The sets should be replaced in the same "
                << v::endl;
        v::info << name() << " *    order they have been written in 6."
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 8. Fill line 3 offset 2 of set 1 and 2 "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * 9. Check if the data was cached correctly "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 10. Check LRR - The sets should be replaced in the same "
                << v::endl;
        v::info << name() << " *     order they have been written in 6."
                << v::endl;
        v::info << name()
