...
void testbench::initiator_thread(void) {
    ...
    while (1) {
        ...
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        v::info << name() << " * Phase 3: write data with virtual addressing "
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                << " * Write to VADDR: 0x01041000,  MMU will map to PADDR: 0x00004000"
                << v::endl;
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        ...
        v::info << name() << " * Write to VADDR: 0x01041000 - 0x01041ffc"
                << v::endl;
        v::info << name() << " * -> fill physical page: 0x4000 - 0x4ffc"
                << v::endl;
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        ...
        v::info << name() << " * This will completely fill the 8 entry DTLB "
                << v::endl;
        v::info << name() << " * Write to VADDR: 0x01042000 - 0x01048ffc"
                << v::endl;
        v::info << name() << " * -> fill physical mem: 0x5000 - 0xbffc"
                << v::endl;
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " *  Diagnostic Lookup Data PDC (without causing AMBA reads)   "
                << v::endl;
        v::info << name()
                << " *  (Check all the 8 Data TLBs)                               "
                << v::endl;
        v::info << name()
                << " ************************************************************ "
                << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1041 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1042 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1043 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1044 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1045 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1046 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1047 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Diagnostic lookup DPDC with VPN: 0x1048 returned PTE: "
                << std::hex << data << v::endl;
        ...
        v::info << this->name()
                << "Provoke miss on diagnostic lookup for VPN: 0x1049 - returned PTE: "
                << std::hex << data << v::endl;
        assert(data == 0);
