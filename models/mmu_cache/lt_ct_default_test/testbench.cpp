...
void testbench::initiator_thread(void) {
    ...
    while (1) {
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name() << " * but tags are different (different pages)."
                << v::endl;
        v::info << name()
                << " ************************************************************"
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 4. DCACHE write addr 0x64 (cache write miss)               "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 5. DCACHE write addr 0x464 (cache write miss)              "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 6. DCACHE write addr 0x864 (cache write miss)              "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 7. DCACHE write addr 0xc64 (cache write miss)              "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * Phase 2: The data which has been written in Phase 1 is read back "
                << v::endl;
        v::info << name()
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 8. DCACHE read addr 0x64 (cache miss)         "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name() << "DCACHE read from 0x64 returned " << std::hex
                << data << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 9. DCACHE read again from 0x64 (cache hit)           "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 10. DCACHE read addr 0x464 / same idx diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill one of the empty banks (3 left)              "
                << v::endl;
        v::info << name()
                << " ********************************************************** "
                << v::endl;
        data = dread(0x464, 4, 0x8, 0, 0, 0, debug);
        v::info << name() << "DCACHE read from 0x464 returned " << std::hex
                << data << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 11. DCACHE read addr 0x864 / same idx,  diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill one of the empty banks (2 left)              "
                << v::endl;
        v::info << name()
                << " ********************************************************** "
                << v::endl;
        ...
        v::info << name() << "DCACHE read from 0x864 returned " << std::hex
                << data << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 12. DCACHE read addr 0xc64 / same idx, diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill the last empty bank                          "
                << v::endl;
        v::info << name()
                << " ********************************************************** "
                << v::endl;
        ...
        v::info << name() << "DCACHE read from 0xc64 returned " << std::hex
                << data << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 13. DCACHE read from 0x464 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 14. DCACHE read from 0x864 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 15. DCACHE read from 0xc64 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 16. ICACHE read addr 0x64 (cache miss)         "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name() << "ICACHE read from 0x64 returned " << std::hex
                << data << v::endl;
        assert(data == 0x04030201);
        assert(CACHEREADMISS_CHECK(*debug));
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 17. ICACHE read again from 0x64 (cache hit)           "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 18. ICACHE read addr 0x464 / same idx, diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill one of the empty banks (3 left)              "
                << v::endl;
        ...
        v::info << name() << "ICACHE read from 0x464 returned " << std::hex
                << data << v::endl;
        assert(data == 0x08070605);
        assert(CACHEREADMISS_CHECK(*debug));
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 19. ICACHE read addr 0x864 / same idx, diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill one of the empty banks (2 left)              "
                << v::endl;
        ...
        v::info << name() << "ICACHE read from 0x864 returned " << std::hex
                << data << v::endl;
        assert(data == 0x0c0b0a09);
        assert(CACHEREADMISS_CHECK(*debug));
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 20. ICACHE read addr 0xc64 / same idx, diff tag (cache miss) "
                << v::endl;
        v::info << name()
                << " * should fill the last empty bank                          "
                << v::endl;
        ...
        v::info << name() << "ICACHE read from 0xc64 returned " << std::hex
                << data << v::endl;
        assert(data == 0x100f0e0d);
        assert(CACHEREADMISS_CHECK(*debug));
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 21. ICACHE read from 0x464 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 22. ICACHE read from 0x864 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * 23. ICACHE read from 0xc64 (cache hit) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 24. Content of ICACHE line 25 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 25. Content of DCACHE line 25 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * Phase 4: Test diagnostic read/write of caches "
                << v::endl;
        v::info << name()
                << " ******************************************************************** "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 26. DCACHE read TAG from set 0 line 25 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name() << "DCACHE returned TAG: " << std::hex << data
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 27. DCACHE read TAG from set 1 line 25 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 28. DCACHE read TAG from set 2 line 25 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 29. DCACHE read TAG from set 3 line 25 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 30. DCACHE read entry 0 from set 0 line 25 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name() << "DCACHE returned DATA: " << std::hex << data
                << v::endl;
        assert(data == 0x04030201);
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 31. DCACHE read entry 0 from set 1 line 25 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 32. DCACHE read entry 0 from set 2 line 25 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 33. DCACHE read entry 0 from set 3 line 25 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 34. ICACHE read TAG from set 0 line 25 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 35. ICACHE read TAG from set 1 line 25 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 36. ICACHE read TAG from set 2 line 25 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 37. ICACHE read TAG from set 3 line 25 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 38. ICACHE read entry 0 from set 0 line 25 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 39. ICACHE read entry 0 from set 1 line 25 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 40. ICACHE read entry 0 from set 2 line 25 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 41. ICACHE read entry 0 from set 3 line 25 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 42. DCACHE write TAG to set 0 line 26 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name() << "DCACHE write TAG: " << std::hex << data
                << " Address: 0x340" << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 43. DCACHE write entry 0 to set 0 line 26 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 44. Content of DCACHE line 26 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 45. DCACHE read from Address 0x68 (hit set 0)       "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 46. ICACHE write TAG to set 3 line 26 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name() << "ICACHE write TAG: " << std::hex << data
                << " Address: 0x6340" << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 47. ICACHE write entry 0 to set 3 line 26 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 48. Content of ICACHE line 26 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 49. ICACHE read from Address 0x468 (hit set 3)       "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name() << "ICACHE returned data: " << std::hex << data
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 50. Flush instruction cache (write with ASI 0x10)    "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 51. Flush data cache (write with ASI 0x11)    "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 52. invalidate icache address 0x468                 "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 53. invalidate dcache address 0x468                 "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 54. ICACHE read from Address 0x468 (miss)           "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 55. DCACHE read from Address 0x68 (hit set 0)       "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 56. ICACHE write TAG to set 3 line 26 (ASI 0xC) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 57. ICACHE write entry 0 to set 3 line 26 (ASI 0xD) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 58. DCACHE write TAG to set 0 line 26 (ASI 0xE) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 59. DCACHE write entry 0 to set 0 line 26 (ASI 0xF) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 60. Flush instruction cache with CCR FD/FI (ASI 0x2)"
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 61. Invalidate icache address 0x868                 "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 62. Invalidate dcache address 0xc68                 "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 63. Content of DCACHE line 26 (dbg_out)         "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 64. Content of ICACHE line 26 (dbg_out)         "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 65.ICACHE read from Address 0x868 (miss)           "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 66. DCACHE read from Address 0xc68 (miss)            "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of DCACHE line 25 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of DCACHE line 26 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of ICACHE line 25 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of ICACHE line 26 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* Phase 6: Sub-word access            "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 67. Store 4 bytes to tag 5 line 0 (miss)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 68. Read 1 word and check result (miss)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 69. Read 2 shorts and check result (hit)   "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 70. Read 4 bytes and check result (hit)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 71. Store 2 shorts to tag 5 line 1 (miss)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 72. Read 1 byte from tag 5 line 1 (miss)  "
                << v::endl;
        v::info << name()
                << "* The miss on the byte should cause the complete "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 73. Read the two shorts with one word access (hit)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* Phase 7: Disable caches and test bypass mode!  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 80. DEACTIVATE CACHES by writing the CONTROL REGISTER "
                << v::endl;
        v::info << name() << " * (ASI 0x2 - addr 0)    " << v::endl;
        v::info << name()
                << " ********************************************************* "
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 81. Write word through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 82. Write shorts through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 83. Write bytes through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                << "************************************************* "
                << v::endl;
        v::info << name() << "* 84. Read word through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 85. Read shorts through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 86. Read shorts through data interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 87. Read word through instr. interface (bypass) "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 88. Invalidate line 0 in all sets of i/d cache. "
                << v::endl;
        v::info << name() << "* The atag of set 0 - 3 is set to 0 - 3.  "
                << v::endl;
        v::info << name()
                << "* This will allow unvalid entries to be replaced "
                << v::endl;
        v::info << name() << "* by new data with the same tag in frozen mode."
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << "* 89. Fill mem with data for tag 0 - 5 (line 0)  "
                << v::endl;
        v::info << name()
                << "************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 90. ACTIVATE CACHES by writing the CONTROL REGISTER "
                << v::endl;
        v::info << name() << " * (ASI 0x2 - addr 0)    " << v::endl;
        v::info << name()
                << " ********************************************************* "
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 91. Fill one of the four sets with data (tag 0, line 0) "
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 92. FREEZE CACHES by writing the CONTROL REGISTER "
                << v::endl;
        v::info << name() << " * (ASI 0x2 - addr 0)    " << v::endl;
        v::info << name()
                << " ********************************************************* "
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 93. Read from tag 1, 2 and 3. This should fill line 0 "
                << v::endl;
        v::info << name() << " * of the remaining 3 sets " << v::endl;
        v::info << name()
                << " * The data is cached despite the fact that the cache is"
                << v::endl;
        v::info << name()
                << " * frozen, because no preexisting valid data is destroyed."
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 94. Line 0 has been filled with valid data, in all four"
                << v::endl;
        v::info << name()
                << " * cache sets. Reading again from line 0 (with another tag)"
                << v::endl;
        v::info << name()
                << " * prevents the new data from being cached due to the freeze."
                << v::endl;
        v::info << name()
                << " ********************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 95. Check whether the four original tags are still "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of DCACHE line 0 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************ "
                << v::endl;
        ...
        v::info << name()
                << " ************************************************* "
                << v::endl;
        v::info << name() << " * Content of ICACHE line 0 (dbg_out)        * "
                << v::endl;
        v::info << name()
                << " ************************************************* "
                << v::endl;
        ...
        v::info << name()
                ...
                << v::endl;
        v::info << name()
                << " * 96. ACTIVATE CACHES by writing the CONTROL REGISTER "
                << v::endl;
        v::info << name() << " * (ASI 0x2 - addr 0)    " << v::endl;
        v::info << name()
                << " ********************************************************* "
