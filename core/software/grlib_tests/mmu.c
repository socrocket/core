...
#define a_31000000 DEF_ADDR(0x3,3,0,0)
    ...
    *((unsigned long **)&pth_addr) =  pthaddr;
    ...
    if((*((unsigned long *)a_30080000)) != (*((unsigned long *)0x40000000))) {
        fail(2);
    }
    ...
    *((volatile unsigned long *)a_30041004) = 0x87654321;
    if((*((volatile unsigned long *)a_30041004)) != 0x87654321 ) {
        fail(3);
    }
    /* doubleword write */
    __asm__ __volatile__("mov %0 ,%%g1\n\t"	\
                         ...
                         "r" (a_30041000) :
                         "g1","g2","g3");
    if((*((volatile unsigned long *)a_30041000)) != 0x12345678 || (*((volatile unsigned long *)a_30041004)) != 0xabcdef01) {
        fail(4);
    }
