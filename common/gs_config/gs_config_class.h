...
public:                                                                   \
    ...
    explicit gs_config(const char *nam,        const char *val       , gs_param_array* parent_array) : gs_config_t<val_type>(string(nam), false, parent_array, true) { gs_config_t<val_type>::init(convertStringToValue(string(val))); } \
    explicit gs_config(const std::string &nam, const char *val       , gs_param_array* parent_array) : gs_config_t<val_type>(nam        , false, parent_array, true) { gs_config_t<val_type>::init(convertStringToValue(string(val))); } \
    explicit gs_config(const char *nam,        const std::string &val, gs_param_array* parent_array) : gs_config_t<val_type>(string(nam), false, parent_array, true) { gs_config_t<val_type>::init(convertStringToValue(val)); } \
